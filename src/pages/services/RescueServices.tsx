...
const RescueServices: React.FC = () => {
  ...
  const handleTalkToUs = useCallback(
    (callType: "emergency" | "general" = "general") => {
      ...
      try {
        ...
        setTimeout(() => {
          ...
          // Log success metrics
          console.log(
            `Call benchmark - Duration: ${duration}ms, Type: ${callType}`
          );
        }, 100);
      } catch (error) {
  ...
  const rescueServices = [
    {
      ...
      description:
        "Immediate response for vehicle breakdowns anywhere in Uganda",
      icon: <RescueIcon />,
      features: [
        {
    ...
    },
    {
      ...
      description:
        "Safe vehicle recovery and towing to your preferred location",
      icon: <TowingIcon />,
      features: [
        {
    ...
    },
    {
      ...
      description:
        "Quick mechanical fixes performed at your breakdown location",
      icon: <RepairIcon />,
      features: [
        {
    ...
    },
    {
      ...
      description:
        "Immediate response and assistance for road traffic accidents",
      icon: <SecurityIcon />,
      features: [
        {
  ...
  return (
    <Box>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        >
          Professional, reliable, and safety-first emergency assistance when you
          need it most.
        </Typography>
        ...
        <Grid container spacing={4}>
          {keyBenefits.map((benefit, index) => (
            <Grid item xs={12} sm={6} md={3} key={index}>
              ...
              >
                <IconWrapper sx={{ mx: "auto" }}>{benefit.icon}</IconWrapper>
      ...
      <Box sx={{ backgroundColor: "grey.50", py: 8 }}>
        <Container maxWidth="lg">
          ...
          <Typography
            ...
            sx={{ mb: 6, maxWidth: 800, mx: "auto" }}
          >
            Comprehensive roadside assistance services to get you back on the
            road safely.
          </Typography>
                      ...
                      {service.features.map((feature, idx) => (
                        ...
                        >
                          <ListItemIcon sx={{ minWidth: 40 }}>
                            <PriorityIndicator
                              priority={
                                feature.priority as "high" | "medium" | "low"
                              }
                            >
                              {feature.icon}
                            </PriorityIndicator>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        >
          Four simple steps to get professional help when you need it most. Our
          streamlined process ensures rapid response and effective assistance.
        </Typography>
        ...
        <Box sx={{ position: "relative", mt: 6 }}>
          ...
          <Grid
            container
            spacing={4}
            sx={{ position: "relative", zIndex: 1, alignItems: "stretch" }}
          >
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        >
          ...
          >
            Don't wait until you're stranded. Join AA Uganda today and travel
            with confidence knowing help is just a phone call away.
          </Typography>
          <Stack
      ...
      {import.meta.env.DEV && (
        <Box sx={{ position: "fixed", bottom: 16, right: 16, zIndex: 1000 }}>
          <Paper
            sx={{ p: 2, backgroundColor: "rgba(0,0,0,0.8)", color: "white" }}
          >
            ...
            <Typography variant="caption" sx={{ display: "block" }}>
              Last Call:{" "}
              {callMetrics.lastCallTimestamp?.toLocaleTimeString() || "N/A"}
            </Typography>
          </Paper>
        </Box>
      )}
