    ...
    <Box>
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="h6" color="text.secondary" sx={{ mb: 4, lineHeight: 1.6 }}>
                At AA Uganda, we provide professional vehicle inspections designed to protect your safety and investment. Our experienced technicians perform comprehensive assessments using standardized AA checklists.
              </Typography>
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ textAlign: 'center' }}>
                <InspectionIcon sx={{ fontSize: 200, color: 'primary.main', opacity: 0.1 }} />
              </Box>
            </Grid>
          </Grid>
        </Container>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        <Typography variant="h6" align="center" color="text.secondary" sx={{ mb: 6, maxWidth: 800, mx: 'auto' }}>
          Comprehensive vehicle inspection services tailored to your specific needs and requirements.
        </Typography>
      ...
      <Box sx={{ backgroundColor: 'grey.50', py: 8 }}>
        <Container maxWidth="lg">
          ...
          <Typography variant="h6" align="center" color="text.secondary" sx={{ mb: 6, maxWidth: 800, mx: 'auto' }}>
            Our comprehensive inspection covers all critical vehicle systems and components.
          </Typography>
                ...
                <Paper sx={{ p: 3, textAlign: 'center', height: '100%', borderRadius: 2 }}>
                  ...
                  <List dense>
                    {category.items.map((item, idx) => (
                      <ListItem key={idx} sx={{ pl: 0, py: 0.25 }}>
                        <ListItemIcon sx={{ minWidth: 20 }}>
                          <CheckIcon sx={{ fontSize: '0.8rem', color: 'primary.main' }} />
                        </ListItemIcon>
                        <ListItemText 
                          primary={item}
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body1" sx={{ mb: 4, opacity: 0.9 }}>
                Enjoy exclusive benefits and priority service as an AA Uganda member, including discounted rates and premium support services.
              </Typography>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        <Typography variant="h6" align="center" color="text.secondary" sx={{ mb: 6 }}>
          Comprehensive digital reports with photo evidence and expert recommendations
        </Typography>
          ...
          <Grid item xs={12} md={6}>
            <Stack spacing={3}>
              <Paper sx={{ p: 3, textAlign: 'center', borderRadius: 2 }}>
                ...
                <Typography variant="h6" gutterBottom>Detailed Documentation</Typography>
                <Typography variant="body2" color="text.secondary">
                  Comprehensive reports with technical findings and recommendations
                </Typography>
              </Paper>
              <Paper sx={{ p: 3, textAlign: 'center', borderRadius: 2 }}>
              ...
              <Paper sx={{ p: 3, textAlign: 'center', borderRadius: 2 }}>
                ...
                <Typography variant="h6" gutterBottom>Digital Delivery</Typography>
                <Typography variant="body2" color="text.secondary">
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        >
          ...
          <Typography variant="h6" color="text.secondary" sx={{ mb: 4, maxWidth: 600, mx: 'auto' }}>
            Book your inspection today and drive with confidence knowing your vehicle meets the highest safety standards.
          </Typography>
