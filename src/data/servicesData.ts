...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: 'Get comprehensive Class B driver training with both practical and theory lessons. Our full package includes 4 weeks of practical training and a 3-year driver\'s license. Contact Ms. Robina at +256 782 756287 for inquiries.',
    icon: 'School',
    category: 'driving',
    features: [
