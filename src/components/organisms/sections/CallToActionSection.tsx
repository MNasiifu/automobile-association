...
const CTASection = styled(Box)(({ theme }) => ({
  ...
  "&::before": {
    ...
    bottom: 0,
    background:
      'url("data:image/svg+xml,%3Csvg width="80" height="80" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="0.05"%3E%3Cpath d="M0 0h80v80H0V0zm20 20v40h40V20H20zm20 35a15 15 0 1 1 0-30 15 15 0 0 1 0 30z" fill-rule="nonzero"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")',
    zIndex: 1,
  },
}));
...
const quickActions = [
  {
    ...
    description:
      "Need immediate roadside assistance? Our rescue team is ready 24/7.",
    action: "Call Now",
  ...
  },
  {
    ...
    description:
      "Learn to drive with professional instructors. Full package with license.",
    action: "Enroll Today",
  ...
  },
  {
    ...
    title: "Get Insurance",
    description:
      "Protect your vehicle with comprehensive motor insurance coverage.",
    action: "Get Quote",
  ...
  },
  {
    ...
    description:
      "Professional vehicle inspection and maintenance advisory services.",
    action: "Book Service",
    ...
    <CTASection>
      <CTAContainer maxWidth="lg">
        ...
        <MainCTABox>
          ...
          >
            Join thousands of satisfied members who trust AA Uganda for their
            motoring needs
          </Typography>
